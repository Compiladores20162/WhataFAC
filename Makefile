...
clean:
	rm -f *.swp lexico.* logOfErrors.txt sintatico.* out.c whatafac.out printNameVariables.txt printTypeVariables.txt a.out quantityOfCloses.txt SimbolsTable.txt
